...
# Пресеты берутся из research/presets/*.json (единый источник с research).
CODE_PRESETS = {
    name: _load_preset(name)
    for name in (
        "WAVELET_16_8_CONFIG",
...
# Исторические id, используемые фронтендом и тестами.
CODE_PRESETS.update(
    {
        "GRS_BINARY_16_8": CODE_PRESETS["REED_SOLOMON_16_8_CONFIG"],
        "GRS_BINARY_32_16": CODE_PRESETS["REED_SOLOMON_32_16_CONFIG"],
        "GRS_BINARY_64_32": CODE_PRESETS["REED_SOLOMON_64_32_CONFIG"],
    }
)
...
RESEARCH_PRESETS = {
    ...
    for name in (
        ...
        "EQUAL_DECODER_SMOKE_THREE_FAMILIES",
...
RESEARCH_PRESETS.update(
    {
        "FOUR_FAMILIES_20K_16_8": RESEARCH_PRESETS[
            "EQUAL_DECODER_20K_FOUR_FAMILIES_16_8"
        ],
        "FOUR_FAMILIES_20K_32_16": RESEARCH_PRESETS[
            "EQUAL_DECODER_20K_FOUR_FAMILIES_32_16"
        ],
        "FOUR_FAMILIES_20K_64_32": RESEARCH_PRESETS[
            "EQUAL_DECODER_20K_FOUR_FAMILIES_64_32"
        ],
        "NEW_CHANNELS_RAYLEIGH": RESEARCH_PRESETS[
            "NEW_CHANNELS_RAYLEIGH_CONFIG"
        ],
        "NEW_CHANNELS_SINUSOIDAL": RESEARCH_PRESETS[
            "NEW_CHANNELS_SINUSOIDAL_CONFIG"
        ],
        "NEW_CHANNELS_RAYLEIGH_AWGN": RESEARCH_PRESETS[
            "NEW_CHANNELS_RAYLEIGH_AWGN_CONFIG"
        ],
        "NEW_CHANNELS_AWGN_BASELINE": RESEARCH_PRESETS[
            "NEW_CHANNELS_AWGN_BASELINE_CONFIG"
        ],
        "REALISTIC_SINUSOIDAL_TEST": RESEARCH_PRESETS[
            "REALISTIC_SINUSOIDAL_TEST_CONFIG"
        ],
    }
)
